...
function mapProduct(raw: unknown): AppProduct | null {
  ...
  return {
    ...
    accentColor: pickString(raw, ['accentColor']) || undefined,
    titleColor: pickString(raw, ['titleColor']) || undefined,
    remarkColor: pickString(raw, ['remarkColor']) || undefined,
    labelColor: pickString(raw, ['labelColor']) || undefined,
    valueColor: pickString(raw, ['valueColor']) || undefined,
    unitColor: pickString(raw, ['unitColor']) || undefined,
    btnColor: pickString(raw, ['btnColor']) || undefined,
    btnTextColor: pickString(raw, ['btnTextColor']) || undefined,
...
export function mapAppProductToItem(product: AppProduct, index = 0): ProductItem {
  ...
  return {
    ...
    desc: product.remark || '--',
    cover,
    theme: product.theme || (index % 2 === 1 ? '#7B6BFF' : '#2F7BFF'),
    ...
    titleColor: product.titleColor || undefined,
    remarkColor: product.remarkColor || undefined,
    labelColor: product.labelColor || undefined,
    valueColor: product.valueColor || undefined,
    unitColor: product.unitColor || undefined,
    btnColor: product.btnColor || undefined,
    btnTextColor: product.btnTextColor || undefined,
