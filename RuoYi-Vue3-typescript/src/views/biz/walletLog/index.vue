<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList">
      ...
      <el-table-column label="类型" align="center" prop="bizType" width="140" />
      <el-table-column label="金额" align="center" prop="amount" width="100" />
      <el-table-column label="可用前" align="center" prop="availableBefore" width="100" />
      <el-table-column label="可用后" align="center" prop="availableAfter" width="100" />
...
function getList() {
  loading.value = true
  listWalletLog(queryParams.value).then((res: any) => {
